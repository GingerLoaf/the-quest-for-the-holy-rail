Shader "HolyRail/MatrixRain_Obstacle"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void ConfigureProcedural()
            {
                ...
                ObstacleData obstacle = _ObstacleBuffer[instanceID];

                float3 pos = obstacle.Position;
                float3 scale = obstacle.Scale;
                float4 rot = obstacle.Rotation;
